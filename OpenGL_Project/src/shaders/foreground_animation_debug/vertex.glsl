...
void main()
{
    ...
    for (int i = 0; i < MAX_BONE_INFLUENCE; ++i)
    {
        ...
        if (index == 23 || index == 1)
        {
            ...
            if (weight > 0.9)
                ...
                debug_color = vec4(0.0f, 1.0f, 0.0f, 1.0f);
            else
                debug_color = vec4(0.0f, 0.0f, 1.0f, 1.0f);
        }
        else
            use_debug_color = 0;
    ...
    gl_Position = projection_matrix * mat4(1.0f) * final_position;
